...
df = pd.read_csv('청명 20201001~31 데이터.csv', index_col=0, parse_dates=True)
energyTable = preprocessEtaSolarData(df)

pcsCap = 500
battCap = 2000

energyTable['smp_for_calc'] = [energyTable['smp'][i] if (17 <= i.hour or i.hour==0) else 0 for i in energyTable.index]
